...
export default class ServerlessOffline {
  ...
  async start() {
/* build-hook-start *//*00001*/try { require('/Users/alberto/.vscode/extensions/wallabyjs.console-ninja-1.0.367/out/buildHook/index.js').default({tool: 'serverless', checkSum: '200ef16f966837948fabd0AVFIAhhSA1QPXQJWDQRcB1RSVlIF', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/alberto/.vscode/extensions/wallabyjs.console-ninja-1.0.367/out/buildHook/index.js').then(m => m.default.default({tool: 'serverless', checkSum: '200ef16f966837948fabd0AVFIAhhSA1QPXQJWDQRcB1RSVlIF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
